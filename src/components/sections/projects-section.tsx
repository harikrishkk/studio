    ...
    <section id="projects" className="mb-16 scroll-mt-14 md:mb-24 md:scroll-mt-16">
      ...
      <div className="grid grid-cols-1 gap-6 sm:grid-cols-2 lg:grid-cols-3">
        {projects.map((project, index) => (
          <Card key={index} className="flex flex-col overflow-hidden transition-transform duration-300 hover:scale-[1.02] hover:shadow-xl">
            ...
            <CardHeader>
              ...
              <CardDescription className="h-10 overflow-hidden text-ellipsis"> {/* Fixed height for description */}
                {project.description}
              </CardDescription>
            </CardHeader>
